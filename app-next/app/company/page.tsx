    ...
    <DashboardLayout>
      <div className="max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Link href="/company/analytics" className="card hover:border-[var(--color-accent)] transition-colors">
            <div className="w-12 h-12 rounded-xl bg-[var(--color-accent)]/10 flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-[var(--color-accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-sm text-[var(--color-text-muted)]">Track your hiring performance</p>
          </Link>
        </div>
      </div>
    </DashboardLayout>
