 ...
 */
export function isBlockedDomain(email: string | null | undefined): boolean {
 ...
 */
export function extractDomain(email: string | null | undefined): string | undefined {
...
export const TEST_FORMAT_TEMPLATES: Record<string, string> = {
