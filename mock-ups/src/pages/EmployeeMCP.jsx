...
export default function EmployeeMCP({ navigate }) {
  ...
  const generateToken = () => {
    ...
    setToken('vj_sk_live_' + Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15))
    setShowToken(true)
  }
      ...
      <main className="container py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-sm text-[var(--color-text-muted)] mb-8">
            <button onClick={() => navigate('dashboard')} className="hover:text-[var(--color-text-primary)]">
              Dashboard
            </button>
            <span>/</span>
          ...
          <p className="text-[var(--color-text-muted)] mb-8">
            Use Vibe Jobs through Claude and other MCP-compatible AI tools
          </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <ul className="text-sm text-[var(--color-text-muted)] space-y-1">
                  <li>• Browse and search jobs through natural conversation</li>
                  <li>• Apply to jobs without leaving your AI workflow</li>
                  <li>• Track application status and get updates</li>
            ...
            {!token ? (
              <div>
                <p className="text-[var(--color-text-muted)] mb-6">
                  Generate an API token to connect Claude Desktop to your Vibe Jobs account.
                </p>
                <button
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-sm text-[var(--color-text-muted)]">
                See all commands for browsing jobs and applying
              </p>
            </button>
            <button
