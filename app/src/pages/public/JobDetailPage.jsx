    ...
    <div className="min-h-screen bg-grid">
      ...
      <nav className="container flex items-center justify-between py-6">
        ...
        <div className="flex items-center gap-4">
          ...
          {isAuthenticated ? (
            <Link to={isEmployee ? '/dashboard' : '/company'} className="btn btn-secondary">
              Dashboard
            </Link>
          ) : (
            <Link to="/signup" className="btn btn-primary">Create profile</Link>
          )}
        </div>
      </nav>
