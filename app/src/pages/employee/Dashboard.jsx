  ...
  useEffect(() => {
    if (applications) {
      setStats({
        ...
        saved: 0, // Will be fetched separately
      ...
      {!hasProfile && (
        <div className="card mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/dashboard/profile" className="btn btn-primary text-sm">
              Create Profile
            </Link>
          </div>
        </div>
        ...
        <div className="card">
          ...
          {loadingJobs ? (
            ...
            <div className="text-center py-8">
              ...
              <Link to="/dashboard/profile" className="btn btn-secondary text-sm">
                Complete Profile
              </Link>
            </div>
          )}
